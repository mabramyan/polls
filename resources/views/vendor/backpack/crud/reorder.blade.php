...
@if ($crud->hasAccess('list'))
    <a href="{{ url($crud->route) }}" onclick="getExportLocation(this,event)" class="hidden-print"><i class="fa fa-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{ $crud->entity_name_plural }}</span></a>
@endif
...
<script>
    ...
    {
        ob.href = "{{ url($crud->route.'') }}" + window.location.search;
    }
</script>
@endsection
